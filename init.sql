...
CREATE TABLE `User` (
  ...
  `family` VARCHAR(400) NULL DEFAULT NULL,
...
CREATE TABLE `KnowledgeRequestTag` (
  `id` INTEGER NULL  DEFAULT NULL,
  `KnwoledgeRequestID` INTEGER NOT NULL DEFAULT NULL,
  `TagID` INTEGER NOT NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
);
CREATE TABLE `File` (
...
CREATE TABLE `Message` (
  `id` INTEGER NULL  DEFAULT NULL,
  `SenderID` INTEGER NOT NULL DEFAULT NULL,
  `RecieverID` INTEGER NOT NULL DEFAULT NULL,
  `subject` CHAR(200) NULL DEFAULT NULL,
  `body` MEDIUMTEXT(20000) NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
);
CREATE TABLE `MessageNotification`(
  `id` INTEGER NULL  DEFAULT NULL,
  `UserID` INTEGER  NULL DEFAULT 0,
  `MessageID` INTEGER NULL DEFAULT 0,
  PRIMARY KEY (`id`)
);
END TRANSACTION;
